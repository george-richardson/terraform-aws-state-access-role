...
run "can_write_configured_workspace_state_file" {
  module {
    source = "./tests/policy_simulation"
  }
  ...
  assert {
    condition     = output.test_results.all_allowed
    error_message = "Cannot write configured workspace state file."
  }
}
...
run "can_read_configured_workspace_lock" {
  module {
    source = "./tests/policy_simulation"
  }
  ...
  assert {
    condition     = output.test_results.all_allowed
    error_message = "Cannot read lock for configured workspace."
  }
}

run "can_read_configured_workspace_lock_hash" {
  module {
    source = "./tests/policy_simulation"
  }
  ...
  assert {
    condition     = output.test_results.all_allowed
    error_message = "Cannot read lock hash for configured workspace."
  }
}

run "can_write_configured_workspace_lock" {
  module {
    source = "./tests/policy_simulation"
  }
  ...
  assert {
    condition     = output.test_results.all_allowed
    error_message = "Cannot write lock for configured workspace."
  }
}

run "can_write_configured_workspace_lock_hash" {
  module {
    source = "./tests/policy_simulation"
  }
  ...
  assert {
    condition     = output.test_results.all_allowed
    error_message = "Cannot write lock hash for configured workspace."
  }
}
